 ...
 * Date: 3/22/2014
 *
 * This application demonstrates a class that provides a graphical display to the user that shows a simulation of an
 * infection spreading through a population operating under certain fundamental rules.
 */
